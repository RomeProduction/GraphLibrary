...
namespace GraphLibrary.Models.Collection {
	...
	public class PriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>, IBag<TPriority, TValue> 
		...
		public void PushVal(TPriority priority, TValue val) {
